...
public static class SwaggerExtensions
{
    ...
    private const string TITLE = "SFC.Scheme";
    private const string SECURITY_ID = "SFC.Scheme - Bearer";
    ...
    public static void AddSwagger(this WebApplicationBuilder builder)
    {
        builder.Services.AddSwaggerGen(setupAction =>
        {
            setupAction.SwaggerDoc(SPECIFICATION_NAME, new()
            {
                Title = TITLE,
                Version = "1",
                Description = "Through this API you can create, update, get and find information about Schemes.",
                Contact = new()
                {
    ...
    private static string GetCustomSchemaId(Type type)
    {
        ...
        string modelsPart = "SFC.Scheme.Api.Infrastructure.Models.Schemes.";
