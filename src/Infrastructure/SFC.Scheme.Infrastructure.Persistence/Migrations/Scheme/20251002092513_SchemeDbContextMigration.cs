    ...
    public partial class SchemeDbContextMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2025, 10, 2, 9, 25, 12, 666, DateTimeKind.Utc).AddTicks(2310), "Formation" },
                    { 1, new DateTime(2025, 10, 2, 9, 25, 12, 666, DateTimeKind.Utc).AddTicks(2326), "Custom" }
                });
