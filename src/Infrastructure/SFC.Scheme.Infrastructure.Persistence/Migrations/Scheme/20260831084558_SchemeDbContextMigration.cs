        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameTeamSchemes_Games_GameId",
                        column: x => x.GameId,
                        principalSchema: "Game",
                        principalTable: "Games",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamSchemes_Users_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Users",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamSchemeFormations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormations_Formations_FormationId",
                        column: x => x.FormationId,
                        principalSchema: "Scheme",
                        principalTable: "Formations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormations_GameTeamSchemes_Id",
                        column: x => x.Id,
                        principalSchema: "Scheme",
                        principalTable: "GameTeamSchemes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormations_SchemeTypes_TypeId",
                        column: x => x.TypeId,
                        principalSchema: "Scheme",
            ...
            migrationBuilder.CreateTable(
                name: "GameTeamSchemeGeneralProfiles",
                schema: "Scheme",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamSchemeGeneralProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeGeneralProfiles_GameTeamSchemes_Id",
                        column: x => x.Id,
                        principalSchema: "Scheme",
                        principalTable: "GameTeamSchemes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamSchemeFormations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormations_Formations_FormationId",
                        column: x => x.FormationId,
                        principalSchema: "Scheme",
                        principalTable: "Formations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormations_SchemeTypes_TypeId",
                        column: x => x.TypeId,
                        principalSchema: "Scheme",
                        principalTable: "SchemeTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormations_TeamSchemes_Id",
                        column: x => x.Id,
                        principalSchema: "Scheme",
            ...
            migrationBuilder.CreateTable(
                name: "GameTeamSchemeFormationPlayers",
                schema: "Scheme",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    GameTeamSchemeFormationId = table.Column<long>(type: "bigint", nullable: false),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamSchemeFormationPlayers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormationPlayers_GameTeamSchemeFormations_GameTeamSchemeFormationId",
                        column: x => x.GameTeamSchemeFormationId,
                        principalSchema: "Scheme",
                        principalTable: "GameTeamSchemeFormations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormationPlayers_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateTable(
                name: "TeamSchemeFormationPlayers",
                schema: "Scheme",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TeamSchemeFormationId = table.Column<long>(type: "bigint", nullable: false),
                    PlayerId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamSchemeFormationPlayers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormationPlayers_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalSchema: "Player",
                        principalTable: "Players",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormationPlayers_TeamSchemeFormations_TeamSchemeFormationId",
                        column: x => x.TeamSchemeFormationId,
                        principalSchema: "Scheme",
                        principalTable: "TeamSchemeFormations",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "GameTeamSchemeFormationPlayerPositions",
                schema: "Scheme",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameTeamSchemeFormationPlayerPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormationPlayerPositions_FormationPositions_FormationPositionId",
                        column: x => x.FormationPositionId,
                        principalSchema: "Scheme",
                        principalTable: "FormationPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameTeamSchemeFormationPlayerPositions_GameTeamSchemeFormationPlayers_Id",
                        column: x => x.Id,
                        principalSchema: "Scheme",
                        principalTable: "GameTeamSchemeFormationPlayers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "TeamSchemeFormationPlayerPositions",
                schema: "Scheme",
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamSchemeFormationPlayerPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormationPlayerPositions_FormationPositions_FormationPositionId",
                        column: x => x.FormationPositionId,
                        principalSchema: "Scheme",
                        principalTable: "FormationPositions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamSchemeFormationPlayerPositions_TeamSchemeFormationPlayers_Id",
                        column: x => x.Id,
                        principalSchema: "Scheme",
                        principalTable: "TeamSchemeFormationPlayers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 0, new DateTime(2026, 8, 31, 8, 45, 57, 922, DateTimeKind.Utc).AddTicks(158), "Formation" },
                    { 1, new DateTime(2026, 8, 31, 8, 45, 57, 922, DateTimeKind.Utc).AddTicks(181), "Custom" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemeFormationPlayerPositions_FormationPositionId",
                schema: "Scheme",
                table: "GameTeamSchemeFormationPlayerPositions",
                column: "FormationPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemeFormationPlayers_GameTeamSchemeFormationId",
                schema: "Scheme",
                table: "GameTeamSchemeFormationPlayers",
                column: "GameTeamSchemeFormationId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemeFormationPlayers_PlayerId",
                schema: "Scheme",
                table: "GameTeamSchemeFormationPlayers",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemeFormations_FormationId",
                schema: "Scheme",
                table: "GameTeamSchemeFormations",
                column: "FormationId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemeFormations_TypeId",
                schema: "Scheme",
                table: "GameTeamSchemeFormations",
                column: "TypeId");

            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemes_GameId",
                schema: "Scheme",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameTeamSchemes_UserId",
                schema: "Scheme",
                table: "GameTeamSchemes",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamSchemeFormationPlayerPositions_FormationPositionId",
                schema: "Scheme",
                table: "TeamSchemeFormationPlayerPositions",
                column: "FormationPositionId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSchemeFormationPlayers_PlayerId",
                schema: "Scheme",
                table: "TeamSchemeFormationPlayers",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSchemeFormationPlayers_TeamSchemeFormationId",
                schema: "Scheme",
                table: "TeamSchemeFormationPlayers",
                column: "TeamSchemeFormationId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSchemeFormations_FormationId",
                schema: "Scheme",
                table: "TeamSchemeFormations",
                column: "FormationId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSchemeFormations_TypeId",
                schema: "Scheme",
                table: "TeamSchemeFormations",
                column: "TypeId");
