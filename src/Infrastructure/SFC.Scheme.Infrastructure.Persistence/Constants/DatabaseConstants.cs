namespace SFC.Scheme.Infrastructure.Persistence.Constants;
public static class DatabaseConstants
{
    public const string DefaultSchemaName = "Scheme";
    ...
    public const string GameTeamSchemeForeignKey = "GameTeamSchemeId";
}