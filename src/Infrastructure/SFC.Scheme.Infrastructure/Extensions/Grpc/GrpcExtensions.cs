...
using SFC.Scheme.Infrastructure.Interceptors.Grpc.Client;
using SFC.Scheme.Infrastructure.Interceptors.Grpc.Server;
...
namespace SFC.Scheme.Infrastructure.Extensions.Grpc;
