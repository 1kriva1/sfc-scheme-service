...
namespace SFC.Scheme.Infrastructure.Consumers.Scheme.Data.Game;
...
public class RequireDataConsumerDefinition : ConsumerDefinition<InitializeDataConsumer>
{
    ...
    private Exchange Exchange { get { return _settings.Exchanges.Scheme.Value.Data.Dependent.Game.Initialize; } }

    public RequireDataConsumerDefinition(IConfiguration configuration)
    {
        _settings = configuration.GetRabbitMqSettings();
        EndpointName = "sfc.scheme.game.data.initialize.queue";
    }
